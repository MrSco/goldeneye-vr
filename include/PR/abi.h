...
/*
 * On the host, soft-execute Acmds through the software mixer instead of
 * recording them for an RSP audio task. mixer.h undefines the macros above
 * and redirects each to an immediate Impl (classic aSetBuffer ABI).
 */
#ifdef GEVR
#include "mixer.h"
#endif
