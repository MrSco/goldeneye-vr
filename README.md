...
Also:
- An **in-VR launcher**: ROM check, display mode, screen shape and size, turning, comfort, **aim steadying**, a **left-handed** mode, and an in-game **stats** readout for troubleshooting.
