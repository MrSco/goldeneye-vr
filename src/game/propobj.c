...
struct tvcmd {
    uintptr_t type;
    intptr_t  time;   /* holds a command-list pointer for the jump commands */
    uintptr_t arg2;
};
...
uintptr_t monAnim01DesktopsSatellite[] = {
...
uintptr_t monAnim02Astrological[] = {
...
uintptr_t monAnim0FSatelliteTargeting[] = {
...
uintptr_t monAnim03ThreeWavePattern[] = {
...
uintptr_t monAnim04WavePattern[] = {
     MONRGBA(COLOR_MINESHAFT3, 1),
     MONUSEIMAGE(IMGSINE),
     MONZOOMWIDTH(0x80, 1),
     MONZOOMHEIGHT(0x800, 60),
...
uintptr_t monAnim05GreenTextUp[] = {
     MONUSEIMAGE(IMGTEXT),
...
uintptr_t monAnim06RedTextDown[] = {
     MONUSEIMAGE(IMGTEXT),
...
uintptr_t monAnim07GreenTextDown[] = {
     MONUSEIMAGE(IMGTEXT),
...
uintptr_t monAnim08RedBarGraph[] = {
     MONUSEIMAGE(IMGBARS),
...
uintptr_t monAnim09BlueBarGraph[] = {
     MONUSEIMAGE(IMGBARS),
...
uintptr_t monAnim0AGreenBarGraph[] = {
     MONUSEIMAGE(IMGBARS),
...
uintptr_t monAnim0CSpinningCube[] = {
...
uintptr_t monAnim0DLocWeapArmed[] = {
...
uintptr_t monAnim11KarlYelling[] = {
...
uintptr_t monAnim15RandomSeven[] = {
...
uintptr_t monAnim17RandImageEffect[] = {
...
uintptr_t monRandEffectChanceSHUTTLE1[] = {
...
uintptr_t monRandEffectChanceSHUTTLE2[] = {
...
uintptr_t monRandEffectChanceEARTHFULL1[] = {
...
uintptr_t monRandEffectChanceEARTHFULL2[] = {
...
uintptr_t monRandEffectChanceBLUESTARS[] = {
...
uintptr_t monRandEffectChanceGALAXY1[] = {
...
uintptr_t monRandEffectChanceGALAXY2[] = {
...
uintptr_t monRandEffectChanceEARTHTEXT[] = {
...
uintptr_t monRandEffectChanceTARGETEARTH[] = {
...
uintptr_t monRandEffectChanceGALAXY3[] = {
...
uintptr_t monRandChanceScrollOrZoomRandRGBN[] = {
...
uintptr_t monRandChanceScrollOrZoomRed[] = {
    MONRGBA(COLOR_PERSIANRED, 60),
    MONJUMPTO(monRandChanceScrollOrZoom)
};

uintptr_t monRandChanceScrollOrZoomGreen[] = {
    MONRGBA(COLOR_APPLE, 60),
    MONJUMPTO(monRandChanceScrollOrZoom)
};

uintptr_t monRandChanceScrollOrZoomBlue[] = {
    MONRGBA(COLOR_GOVERNORBAY, 60),
    MONJUMPTO(monRandChanceScrollOrZoom)
};

uintptr_t monRandChanceScrollOrZoom[] = {
    MONHOLDTIME(50),
...
uintptr_t monAnim27RandomEffectScrollRight[] = {
    MONHORZSCROLL(0x800, 120),
    MONHOLDTIME(120),
    MONJUMPTO(monAnim2CRandEffectWaitRoute)
};
...
uintptr_t monAnim28RandomEffectScrollUpFast[] = {
...
uintptr_t monAnim29RandomEffectScrollUp[] = {
...
uintptr_t monAnim2ARandEffectScrollZoom1[] = {
...
uintptr_t monAnim2ARandEffectScrollZoom2[] = {
...
uintptr_t monAnim2CRandEffectWaitRoute[] = {
    MONHOLDTIME(50),
...
uintptr_t monAnim2DRandEffectFlash[] = {
    MONHOLDTIME(50),
...
uintptr_t monAnim2ERedBrightening[] = {
...
uintptr_t monAnim2FGreenBrightening[] = {
     MONUSEIMAGE(IMGKEYBOARDKEY),
     MONZOOMSQUARE(0x200, 0),
     MONRGBA(COLOR_APPLE, 60),
     MONHOLDTIME(60),
    ...
    if (node && (node->Opcode & 0xff) == MODELNODE_OPCODE_DLCOLLISION) 
    {
        ...
        while (!yielding) 
        {
            ...
            case TVCMD_SETCMDLIST:
                save_ptr_monitor_ani_code_to_obj_ani_slot(screen, (uintptr_t *) m->time);
                break;
    ...
    if (prop->flags & PROPFLAG_ONSCREEN)
    {
        ...
        else
        {
            ...
            if (node != NULL)
            {
                ...
                if (nodedata != NULL)
                {
                    rwdataSlot = (void *)&obj->model->datas[nodedata->DisplayListCollisions.RwDataIndex];
...
bool bgTestHitOnObj(coord3d *arg0, coord3d *arg1, coord3d *arg2, Gfx *gdl, Gfx *gdl2, Vertex *vertices, struct HitThing *hitthing)
{
    ...
    {
        /*
         * D135 (gepc-ref): the object bullet-hit GBI parser. A host display
         * list is 16-byte Gfx with the two cartridge words in the low halves of
         * words.w0 / words.w1. Every raw byte/word index here assumed the
         * N64's 8-byte command, so the opcode was read from the wrong byte and
         * the walk never found a G_VTX or a triangle: bullets passed straight
         * through objects -- the Dam gate padlock could not be shot. Read the
         * words instead.
         */
        ...
        {
            op = (w0 >> 16) & 0xf;
            /* This port's model converter tags segmented addresses with bit 0
             * (gevr_model.c convertGdl); strip it the way seg_addr does, or
             * every vertex is read one byte off. gepc-ref's converter does not
             * tag, so its mask is 0x00ffffff. */
            padC = w1 & 0x00fffffe;
        ...
        if (op == (s8)G_TRI1)
        {
            ...
            if (bgTestRayIntersectsBbox(arg0, arg2, (s32 *) (&bboxMin), (s32 *) (&bboxMax)))
            {
                ...
                if (intersectRayTriangle(pt0, pt1, pt2, &zero, arg0, arg1, arg2, &hitbuf))
                {
                    ...
                    tcmd = gdl;
                    /*
                     * D135: the N64 recovers the texture number from
                     * *(s16 *)(phys(w1) - 8) behind the preceding G_SETTIMG,
                     * through a KSEG0 address that faults on the host, and the
                     * converted model layout does not guarantee that word
                     * anyway. A bogus value indexes g_HitTypeSounds[] out of
                     * bounds. texnum only flavours the impact sound and decal,
                     * so fall back to the generic hit, as gepc-ref does.
                     */
                    texnum = -1;
                    (void) tcmd;
            ...
            do
            {
                ...
                if (bgTestRayIntersectsBbox(arg0, arg2, (s32 *) (&bboxMin2), (s32 *) (&bboxMax2)))
                {
                    ...
                    if (intersectRayTriangle(pt0, pt1, pt2, &zero2, arg0, arg1, arg2, &hitbuf))
                    {
                        ...
                        /* D135: see the G_TRI1 note; generic hit. */
                        texnum = -1;
                        (void) tcmd;
...
void objHit(ShotData *shotdata, BulletHit *hit)
{
    ...
    if (shotdata->weapon != ITEM_WATCHLASER)
    {
        ...
        else
        {
            ...
            {
                impact_sounds = g_HitTypeSounds[g_Textures[texturenum].hitTexture]; /* was the low nibble of the big-endian first byte */
            }
...
TICKOP propdoorInteract(PropRecord* doorprop)
{
    ...
    else if ((door->openstate == DOORSTATE_STATIONARY) && (door->openPosition < 0.5f))
    {
        if (!(door->flags2 & PROPFLAG2_00000004))
        {
            ...
            {
                HUDMESSAGEBOTTOM(langGet((s32) txt->pickuptext));
            }
            else
            {
                HUDMESSAGEBOTTOM(langGet(0xA440));
            }
        }
        door->runtime_bitflags |= RUNTIMEBITFLAG_ACTIVATED;
    ...
    for (; s2 != NULL; s2 = s2->prev)
    {
        if ((s2->type == 1) && ((s2->flags & 2) == 0))
        {
            ...
            if (s1->state & 0x80)
            {
                ...
                {
                    new_var = (void *)&s3->datas[s0->RwDataIndex];
