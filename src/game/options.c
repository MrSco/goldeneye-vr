...
/*
 * Defined in gunfire.c against gun.h's WatchContButtonPositions, which this
 * file duplicates above rather than includes. They return pointers, so they
 * must be declared here: called without a prototype, C assumed int and kept
