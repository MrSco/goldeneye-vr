...
void sub_GAME_7F092E50(void)
{
    ...
    gDPSetTileSize(&MipMap2C_Something_Setup[2], 0, (s32)flt_CODE_bss_80079E80, (s32)flt_CODE_bss_80079E84, 0, 0);
    gDPSetTileSize(&MipMap2C_Something_Setup[3], 1, ((s32)flt_CODE_bss_80079E80 + 90) & 0xFF, ((s32)flt_CODE_bss_80079E84 + 150) & 0xFF, 0, 0);
    MipMap2C_Something_Setup[4].words.w0 = (MipMap2C_Something_Setup[4].words.w0 & ~0xFF) | (u32) ((sinf(flt_CODE_bss_80079E88) * 127.0f) + 128.0f);

    gDPSetTileSize(&MipMap2C_Something2_Setup[2], 0, (s32)flt_CODE_bss_80079E80, (s32)flt_CODE_bss_80079E84, 0, 0);
    gDPSetTileSize(&MipMap2C_Something2_Setup[3], 1, ((s32)flt_CODE_bss_80079E80 + 90) & 0xFF, ((s32)flt_CODE_bss_80079E84 + 150) & 0xFF, 0, 0);
    MipMap2C_Something2_Setup[4].words.w0 = MipMap2C_Something_Setup[4].words.w0;
}
