...
void rspGfxTaskStart(Gfx *firstGdl, Gfx *gdl, s32 arg2, OSMesg rspReplyMsg)
{
    ...
    g_gfxTaskSettingsList = (struct GfxInfo_s *)((uintptr_t)g_gfxTaskSettingsList ^ (uintptr_t) &g_gfxTaskSettings[0] ^ (uintptr_t) &g_gfxTaskSettings[1]); /* pointer-width XOR toggle */
}
