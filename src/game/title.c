...
/* PORT: intro matrices backed by persistent static storage so they are never unallocated or corrupted */
...
//CODE.bss:80069558
Mtx *matrixBufferRareLogo0 = s_matrixBufferRareLogo0;
//CODE.bss:8006955C
Mtx *matrixBufferGunbarrel0 = s_matrixBufferGunbarrel0;
//CODE.bss:80069560
Mtx *matrixBufferRareLogo1 = s_matrixBufferRareLogo1;
//CODE.bss:80069564
Mtx *matrixBufferRareLogo2 = s_matrixBufferRareLogo2;
//CODE.bss:80069568
Mtx *matrixBufferGunbarrel1 = s_matrixBufferGunbarrel1;
//CODE.bss:8006956C
Mtx *matrixBufferIntroBackdrop = s_matrixBufferIntroBackdrop;
//CODE.bss:80069570
Mtx *matrixBufferIntroBond = s_matrixBufferIntroBond;
//CODE.bss:80069574
f32 g_TitleX;
//CODE.bss:80069578
f32 g_TitleY;
...
//CODE.bss:80069590
u8 *virtualaddress; /* an address; as s32 it lost its top half */
...
void sub_GAME_7F008DE4(u8 **addr, s32 *size) {
    ...
    *addr += 0x40400;
    ...
    romCopy(dword_CODE_bss_80069588, unknown2, ALIGN64_V2(((uintptr_t)unknown2_end - (uintptr_t)unknown2)));
...
void initializeGunBarrelIntro(u8 *gfxBuffer, s32 bufferSize)
{
    ...
    /* PORT: sub_GAME_7F01BFF8 writes 31 commands here; 248 bytes on the cartridge, 496 with
       16-byte host commands, so the slot is doubled or the list runs into the RLE image behind it. */
    bufferSize -= 0x200;
    gfxBuffer += 0x200;
    
    sub_GAME_7F01BFF8(gunbarrelgfxListPointer, (Vtx *)barrelDisplayListPtr, 0x1E);
...
Gfx *renderGunbarrelEyeIntroSequence (Gfx *gdl) {
    ...
    case 1:
        ...
        if (g_TitleX < 600.0f) { gdl = insert_bond_eye_intro(gdl);
        }
        g_TitleX -= XDEC3;
        if (g_TitleX <= -80.0f) {
            gunbarrel_mode++;
    ...
    case 2:
        gdl = insert_sniper_sight_eye_intro(gdl);
        gdl = insert_sight_backdrop_eye_intro(gdl); gdl = insert_bond_eye_intro(gdl);
        intro_eye_counter--;
